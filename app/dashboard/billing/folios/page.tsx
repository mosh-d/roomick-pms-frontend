...
/**
 * Guest Folio list (the reference's Guest Folio search, realised as a list
 * — ref p33 opens with "Search by guest name"). Moved here from the bare
 * `/dashboard/billing` route once Billing and Payments gained a real hub
 * page at that route, matching Reservations/Housekeeping/Front Desk's own
 * "section route is a hub of cards" pattern rather than jumping straight
...
export default function GuestFolioListPage() {
